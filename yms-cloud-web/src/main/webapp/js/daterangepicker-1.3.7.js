    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (this.singleDatePicker) {
                ...
                //改变宽度
                this.container.css('width','310px');
                this.container.find('.ranges').css('width','200px');
            } else {
        ...
        clickRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                this.leftCalendar.month.month(this.startDate.month()).year(this.startDate.year()).hour(this.startDate.hour())
                    .minute(this.startDate.minute()).second(this.startDate.second());
                this.rightCalendar.month.month(this.endDate.month()).year(this.endDate.year()).hour(this.endDate.hour())
                    .minute(this.endDate.minute()).second(this.endDate.second());
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (this.timePicker) {
                ...
                html += '<select class="secondselect" style="height:22px;padding:1px">';
