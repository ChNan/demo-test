...
<body>
<input type="hidden" id="isOutlookLogin" value="${isOutlookLogin}">
...
<div id="con-content">
    ...
    <div class="col-xs-12 m-cp-main" hidden="true" id="c_plan_index" style="margin-top: 25px;height:200px;background-image: url('${pageContext.request.contextPath}/img/conference/background.png');background-repeat: no-repeat;background-position: top center;">
        <div class="tab-content">
            ...
            <div class="panel panel-body" style="margin-top: 10px;border-radius: 0px;border-color: #ddd;padding-bottom: 0;padding-right: ">
                <div class="col-xs-12">
                    <div class="row">
                        <button type="button" class="btn  btn-lg conf-btn conf-selected" redirect="conf_all" searchType="-1" template="conference_plan_list_temp">
    ...
    <div class="col-xs-12 m-cp-main panel panel-body" id="nc_plan_add" hidden="true">

    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="nc_plan_detail" hidden="true">

    </div>

    <div class="col-xs-12 m-cp-main panel panel-body" id="nc_plan_edit" hidden="true">

    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="nc_record_edit" hidden="true">

    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="vc_record_edit" hidden="true">

    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="vc_plan_add" hidden="true">

    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="vc_plan_edit" hidden="true">

    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="vc_plan_detail" hidden="true">

    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="vc_detail_end" hidden="true">

    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="nc_detail_end" hidden="true">
    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="vc_detail_ready" hidden="true">

    </div>
    <div class="col-xs-12 m-cp-main panel panel-body" id="nc_detail_ready" hidden="true">
    ...
    <script id="check_room_temp" type="text/html">
        <div class="fc-widget-content" style="display: inline-block">
...
<div hidden>
    <form  id="submitOutlookForm" action="/main?type=outlook" method = "post" accept-charset="utf-8" >
