...
<div class="m-cp">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" id="m_ncr_detail">
            <div class="row" style="margin-top:30px">
                <div class="c-row-title">
                    <a onclick="conferenceplan.toggleSource('m_ncr_detail', this)" id="toggleSource" style="cursor: pointer;color: #00beeb;"><spring:message code="conferenceplan.jsp.common.label.roomutilization"/>
